...
<html lang="en">
  <head>
    <title>female - male model, tv model, tv anchors advertisement, tv channel</title>
    <meta name="description" content="dream starz media is the leading media entertainment website for current men and women models. fortamil cinema industry, tamiltv channels, advertisment, tv channels, cinema, sort film kids stars, trailers, videos, worldwide no.1 talent search website."/>
    <meta name="identifier" content="https://www.dreamstarz.in/"/>
    <meta name="keywords" content="tvmodles, tv female model, men model, oldage models, models directory, advertisement models you tube models directory, youtube stars, cinema news, tamil movie stars, models, tamil talent hunt,  tamil songs, actress, movie, tamil cine stars, tamil movie online, sort film, mems creators, content creators, you tubers, tamil movie trailer, tamil cinema news, actress photo, "/>
    <meta charset="UTF-8">
               ...
               <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM admin_models_insertion ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="models_view.php?view=echo $row['id']" class="btn btn-danger text-white font-weight-bold">VIEW</a>
                                    </p>
                                    </div>
                                </div> -->
                            </div>
