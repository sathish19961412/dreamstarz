                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="tech_delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger text-white font-weight-bold" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
                                    </p>
                                    </div>
                                </div>
                            </div>
