...
<html lang="en">
  <head>
    <title>youtubers, youtuber, famous youtube channels </title>
    <meta name="description" content="dream starz media is the leading media entertainment website for youtuer and youtube channels, for youtube, tv channel, cinema, industry, advertisement, tv channels, cinema, sort film, worldwide no.1 talent search website."/>
    <meta name="identifier" content="https://www.dreamstarz.in/"/>
    <meta name="keywords" content="youtubers, youtuber, famous youtube channels, finally, dreamstarz, rithu rocks, madangowri, irfan, micset, nakkalites, village cooking channel, food channel, sortfilms, copy writer ,voice over artiest, content developer, copy writer, content creator, memes creator, tami, english, malayalam, kanada, telgu. see tamil, vj and rj search, youtube channels, models directory, mems creators, content creators, you tubers, "/>
    <meta charset="UTF-8">
           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-center ">
                       <h3 class="text-white"  id="font-heading">Youtubers</h3>
                    </div>
                </div>
           </div>
       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Youtubers</h3>
                ...
                <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM youtubers ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="youtubers_view.php?view=echo $row['id'];?>" class="btn btn-danger text-white font-weight-bold">VIEW</a>
                                    </p>
                                    </div>
                                </div> -->
                            </div>
