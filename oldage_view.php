...
$query= mysqli_query($conn, "SELECT * FROM admin_oldage_insertion WHERE id=$id");
?>
            ...
            <div class="row" id="select">
                <div class="col-md-6">
                    <div class="text-center pt-2">
                        <div>
                            <h3 class="line">BEST Oldage IN TAMILNADU</h3>
                        </div>
                    </div>
                </div>
                ...
                <?php while($row=mysqli_fetch_array($query)){?>
                    <div class="row" id="art" >
                        ...
                        <div class="col-md-9 p-3">
                            ...
                            <div class="d-flex">
                                <span class="span-2">Instagram Link</span> <span class="muted-4"><?php echo $row['instagramlink']; ?></span>
                            </div>
                            <div class="d-flex ">
