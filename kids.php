...
<html lang="en">
  <head>
    <title>talent kids, kids artist, cinema, tv channel, india</title>
    <meta name="description" content="dream starz media is the leading media entertainment website for current kids talent hunts for tamil cinema industry, tamiltv channels, tv channels, cinema, sort film kids stars, trailers, videos, worldwide no.1 talent search website."/>
    <meta name="identifier" content="https://www.dreamstarz.in/"/>
    <meta name="keywords" content="tv stars, tv artist, tv kids, kids stars, girl artist, boy artist, you tube kids, cinema kids, rithu rocks, youtube stars, cinema news, tamil movie stars, models, tamilkids talent hunt,  tamil songs, actress, movie, tamil cine stars, tamil movie online, sort film, mems creators, content creators, you tubers,tamil cinema news, kids artist  photo, "/>
    <meta charset="UTF-8">
           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-center mt-4">
                       <h3 class="text-white" id="font-heading">Kids</h3>
                    </div>
                </div>
           </div>
       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">kids</h3>
                ...
                <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM admin_kids_insertion ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="kids_view.php?view=echo $row['id']" class="btn btn-danger text-white font-weight-bold">VIEW</a>
                                    </p>
                                    </div>
                                </div> -->
                            </div>
