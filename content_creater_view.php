...
$query= mysqli_query($conn, "SELECT * FROM content_creater WHERE id=$id");
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Content Creaters</h3>
