...
<html lang="en">
  ...
  <style>
    ...
    #artist
    {
        background:url("assets/banner/womens.gif");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Womens</h3>
                ...
                <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM admin_womens_insertion ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="womens_delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger text-white font-weight-bold" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
                                    </p>
                                    </div>
                                </div>
                            </div>
