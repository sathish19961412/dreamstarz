...
<html lang="en">
  <head>
    <title>vj-rj, video jockey, radio jockey, male and female, tv channel</title>
    <meta name="description" content="dream starz media is the leading media entertainment website for current men and women vi and rj. for cinema industry, tv channels, advertisement, tv channels, cinema, sort film kids stars, trailers, videos, worldwide no.1 talent search website."/>
    <meta name="identifier" content="https://www.dreamstarz.in/"/>
    <meta name="keywords" content="rj, vj, video jockey, radio jockey , priyanka, gopinath, maaka pa, sun tv, vijaytv , see tamil, vj and rj search, youtube channels, models directory, advertisement models you tube models directory, youtube stars, cinema news, tamil movie stars, models, tamil talent hunt,  tamil songs, actress, movie, tamil cine stars, tamil movie online, sort film, mems creators, content creators, you tubers, "/>
    <meta charset="UTF-8">
           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-center mt-5">
                       <h3 class="text-white"  id="font-heading">Vj/rj</h3>
                    </div>
                </div>
           </div>
       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Vj/Rj</h3>
                ...
                <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM admin_vi_rj_insertion ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                     <a href="vi_rj_view.php?view=echo $row['id'];" class="btn btn-danger text-white font-weight-bold">VIEW</a>
                                    </p>
                                    </div>
                                </div> -->
                            </div>
