           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-center mt-4">
                       <h3 class="text-white" id="font-heading">Memes Creators</h3>
                    </div>
                </div>
           </div>
       </div>
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <div class="modal fade" id="edit<?php echo $row['id']?>" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <form method="POST" enctype="multipart/form-data" action="memes_edit.php">
                                ...
                                <div class="col-md-3">
                                    <div class="pt-5">
                                    <p>
                                    <a href="memes_delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger text-white font-weight-bold" onclick="return confirm('Are you sure you want to delete this item?');">Memes DELETE</a>
