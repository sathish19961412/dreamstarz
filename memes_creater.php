...
<html lang="en">
  <head>
    <title>memes creators, social media creator, copy writer, </title>
    <meta name="description" content="dream starz media is the leading media entertainment website for content creators, memes creators, for youtube, tv channel, cinema, industry, advertisement, tv channels, cinema, sort film kids stars, trailers, videos, worldwide no.1 talent search website."/>
    <meta name="identifier" content="https://www.dreamstarz.in/"/>
    <meta name="keywords" content=" memes creators, social media creator, copy writer ,voice over artiest, content developer, copy writer, content creator, memes creator, tami, english, malayalam, kanada, telgu. see tamil, vj and rj search, youtube channels, models directory, mems creators, content creators, you tubers, "/>
    <meta charset="UTF-8">
           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-center ">
                       <h3 class="text-white" id="font-heading">Memes Creaters</h3>
                    </div>
                </div>
           </div>
       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Memes Creaters</h3>
                ...
                <div class="col-md-9" id="artist-2">
                    <div class="row" id="art" >
                        <?php
                            ...
                            $query=mysqli_query($conn,"SELECT*FROM memes_creater ");
                        ...
                        <div class="article-loop">
                            <div class="row row-5" id="art" >
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="mt-5">
                                    <p>
                                    <a href="memes_creater_view.php?view=echo $row['id'];" class="btn btn-danger text-white font-weight-bold">VIEW</a>
                                    </p>
                                    </div>
                                </div> -->
                            </div>
